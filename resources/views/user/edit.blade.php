        ...
        <div class="card-body">
            ...
            @else
                <form method="POST" action="{{ url('/user/' . $user->user_id) }}" class="form-horizontal">
                    @method('PUT') {{-- Add this line for the editing process that requires the PUT method --}}
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <small class="form-text text-muted">Ignore it if you dont want to change the password</small>
                            @error('password')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
